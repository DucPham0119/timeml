...
import sys
sys.path.append('/home/ducpt/heildeltime')
...
def run_time_model(model: str, text: str) -> str:
    if model == "GPT":
        ...
        return heideltime_process1(text)
    elif model == "Heidel-Time":
        return heideltime_process2(text)
    else:
...
#     try:
#         print('extract')
#         result = await process_request(req.text, req.time_model, req.event_model)
#         return result
#     except Exception as e:
